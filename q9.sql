-- TOP 10 HIGHEST SALES AND SALESMEN
...
SALESMAN_ID 	            INT NOT NULL,
SALESMAN_NAME               varchar(50) CHARACTER SET utf8mb4,
...
select s.SALESMAN_ID,sm.SALESMAN_NAME,SUM(s.SALE_AMOUNT) AS TOTAL_SALES_SUM from sales as s JOIN salesman as sm on s.salesman_id=sm.salesman_id GROUP BY s.SALESMAN_ID
order by TOTAL_SALES_SUM DESC limit 10;